 ...
 * User: Kenny Date: 24-nov-2008 Time: 14:34:06
 */

/**
 * The RatioGroup class is a container for capturing both Identifications (and types) and Ratio's.
 * This structure allows us to maintain a many-to-many mapping between Identifications and Ratios.
 *
 * ex from a triple SILAC experiment:
 *
 * One peptide was identified from fragmentation of the light isotopes.
 * Hence, three ratio's where determined:  L/M, L/H and M/H.
 *
 * This RatioGroup will then feed the QuantitationStorage to bind
 * one Identification entry to three Quantitation (Ratio) entries by a quantitationlink.
 *
 *
 */
