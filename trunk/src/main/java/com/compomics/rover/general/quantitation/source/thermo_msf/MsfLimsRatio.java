 ...
 */
public class MsfLimsRatio implements Ratio {
    // Class specific log4j logger for MsfLimsRatio instances.
    private static Logger logger = Logger.getLogger(MsfLimsRatio.class);
    /**
     * The ratio itself.
     */
     ...
     */
    public MsfLimsRatio(Double aRatio, String aType, boolean aValid, RatioGroup aParentRatioGroup) {
        this.iRatio = aRatio;
