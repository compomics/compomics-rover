...
public class MaxQuantEvidenceFile {
    ...
    public RatioGroupCollection getRatioGroupCollection() {
        ...
        //the vector with peptide identifications
        Vector<DefaultPeptideIdentification> lIdentifications = new Vector<DefaultPeptideIdentification>();
        ...
        try {
            ...
            while ((lMsmsLine = lnMsmsreader.readLine()) != null) {
                if (!lMsMsHeaderParsed) {
                    ...
                    lIdentifications.add(lIdentification);
                    lIdentificationsMap.put(lIdentification.getId(), lIdentification);

                    if (lCounter % 50000 == 0) {
                        System.out.println("Found " + lCounter + " MSMS lines");
            ...
            System.out.println("MSMS finding done: "+lCounter +  " lines found!");
            Runtime r = Runtime.getRuntime();
            r.gc();
            r.gc();
            lCounter = 0;
            ...
            while ((line = lnreader.readLine()) != null) {
                if (!lEvidenceHeaderParsed) {
                    ...
                    try {
                        lCounter = lCounter + 1;
                        if (lCounter % 10000 == 0) {
                            System.out.println("Found " + lCounter + " evidence lines!");
                            r.gc();
                            r.gc();
                        }
                            ...
                            if (lColumns[(Integer) lHeaderMap.get("Intensity L")] != "") {
                                ...
                                if(((String)lColumns[(Integer) lHeaderMap.get("Ratio H/L")]).length() != 0){
                                    ...
                                    if (lRatioSignificanceAFound) {
                                        lHLRatio = new MaxQuantRatio(Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L Normalized")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L Significance(A)")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L Significance(B)")]), "H/L", true, lGroup);
                                    } else {
                                        lHLRatio = new MaxQuantRatio(Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L Normalized")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/L")]), "H/L", true, lGroup);
                                    }
                                ...
                                if (lTripleSilac) {
                                    if(((String)lColumns[(Integer) lHeaderMap.get("Ratio H/M")]).length() != 0){
                                        ...
                                        if (lRatioSignificanceAFound) {
                                            lHMRatio = new MaxQuantRatio(Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M Normalized")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M Significance(A)")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M Significance(B)")]), "H/M", true, lGroup);
                                        } else {
                                            lHMRatio = new MaxQuantRatio(Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M Normalized")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio H/M")]), "H/M", true, lGroup);
                                        }
                                    ...
                                    if(((String)lColumns[(Integer) lHeaderMap.get("Ratio M/L")]).length() != 0){
                                        ...
                                        if (lRatioSignificanceAFound) {
                                            lMLRatio = new MaxQuantRatio(Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L Normalized")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L Significance(A)")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L Significance(B)")]), "M/L", true, lGroup);
                                        } else {
                                            lMLRatio = new MaxQuantRatio(Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L Normalized")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L")]), Double.valueOf(lColumns[(Integer) lHeaderMap.get("Ratio M/L")]), "M/L", true, lGroup);
                                        }
